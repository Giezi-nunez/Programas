 ...
 * @author Cesar
 */
public class heroesdc extends Superheroes implements volar,pelear {

    public heroesdc(String nombre, String identidad, String humano, String extraterrestre, String poderes, String Armas, String traje,String mecanismo,String pelea,int nivelpelea) {
        super(nombre, identidad, humano, extraterrestre, poderes, Armas, traje, mecanismo,pelea,nivelpelea);
    }
      public void datos() {
